...
function intializeTradingAppRoutes() {
    ...
    TradingAppRouter.post('/api/strategy', routeGuard, upload.fields([{name: 'callfile', maxCount: 1}, {name: 'putfile', maxCount: 1}]), controlPanelController.registerOrUpdateStrategy);
    TradingAppRouter.put('/api/strategy', routeGuard, upload.fields([{name: 'callfile', maxCount: 1}, {name: 'putfile', maxCount: 1}]), controlPanelController.registerOrUpdateStrategy);
